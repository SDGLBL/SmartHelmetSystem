...
from detection.mmdet.core import MaxIoUAssigner
from detection.mmdet.core.bbox.samplers import OHEMSampler, RandomSampler
...
def test_random_sample_result():
    from detection.mmdet.core.bbox.samplers.sampling_result import SamplingResult
